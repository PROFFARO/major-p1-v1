"""
KShark Hierarchical Detail Tree Model (ProtoTree Equivalent for System Calls).
...
class DetailTreeModel(QAbstractItemModel):
    """
    Hierarchical model representing KShark dissected layers of an event.
    """
    ...
    def _build_tree(self, event: Dict[str, Any], raw_json: str):
        ...
        header_node = TreeNode(
            name=f"KShark Event: {sc} (PID: {pid} - {comm})",
            value="",
