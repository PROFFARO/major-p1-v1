"""
KShark IO Graph Dialog — Live Throughput, Events/Sec, and Threat Timeline Graph.
Direct port of ui/kshark/kshark_io_graph_dialog.cpp.
"""
...
class KSharkIOGraphDialog(QDialog):
    """
    KShark IO Graph Dialog matching ui/kshark/kshark_io_graph_dialog.cpp.
    """

    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("KShark · IO Graphs")
        self.resize(750, 480)
        self._init_ui()
