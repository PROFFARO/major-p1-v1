"""
KShark Copilot Dock — Local LLM Security Analyst Platform.
"""
...
class CopilotDock(QDockWidget):
    """
    KShark AI Security Copilot Analyst Dock.
    """
    ...
    def _init_ui(self):
        ...
        self.history_view.setHtml("""
            <div style='color: #0E9AA7; font-weight: bold;'>🤖 KShark Security Copilot Online</div>
