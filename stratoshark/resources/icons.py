"""
Stratoshark Vector SVG & Dynamic QPainter Icon Factory.
Generates pixel-accurate Stratoshark Cloud Teal & Wireshark UI icons.
"""
...
class StratosharkIcons:
    """Centralized Icon Factory for Stratoshark Desktop Application."""
    ...
    def get_app_icon(cls) -> QIcon:
        """Stratoshark Teal Shark Fin App Icon."""
    ...
    def capture_start(cls) -> QIcon:
        """Stratoshark Start Capture Shark Fin."""
