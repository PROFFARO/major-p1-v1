"""
Stratoshark Event Table Model — Canonical 11-Column System Call Dissection Table.
...
from stratoshark.core.syscall_table import resolve_syscall_name


class EventTableModel(QAbstractTableModel):
    """
    Virtualized data model for the top Stratoshark Event List pane.
    Canonical Stratoshark columns matching app/stratoshark_flavor.c.
    """
