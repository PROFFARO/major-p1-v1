"""
Stratoshark Capture Options & Interfaces Dialog — Multi-source kernel telemetry configuration.
Direct implementation of Wireshark/Stratoshark capture_interfaces_dialog.cpp.
...
class CaptureOptionsDialog(QDialog):
    ...
    def __init__(self, parent=None, current_ws_url: str = "ws://localhost:8900/ws"):
        ...
        self.setWindowTitle("Stratoshark · Capture Interfaces & Kernel Probes")
        self.resize(780, 520)
