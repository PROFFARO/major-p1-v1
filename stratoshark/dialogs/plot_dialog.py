"""
Stratoshark Plot Dialog — Syscall Frequency, Latency, and Scatter Distribution.
Direct port of ui/stratoshark/stratoshark_plot_dialog.cpp.
"""
...
class StratosharkPlotDialog(QDialog):
    """
    Stratoshark Plot Dialog for Syscall & Event Distribution.
    """

    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("Stratoshark · Event Plot Distribution")
        self.resize(700, 420)
        self._init_ui()
