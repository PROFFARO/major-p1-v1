"""
Stratoshark Preferences & Configuration Profiles Dialog.
"""
...
class PreferencesDialog(QDialog):
    """
    Stratoshark Preferences Dialog.
    """

    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("Stratoshark · Preferences")
        self.resize(560, 360)
    ...
    def _init_ui(self):
        ...
        self.combo_theme.addItem("Stratoshark Cloud Teal (Dark)", ThemeManager.THEME_STRATOSHARK_DARK)
        self.combo_theme.addItem("Stratoshark Cloud Teal (Light)", ThemeManager.THEME_STRATOSHARK_LIGHT)
