"""
Stratoshark About Dialog — Version, Kernel eBPF Support, and Credits.
Direct port of ui/stratoshark/stratoshark_about_dialog.cpp.
"""
...
from stratoshark.core.theme import ThemeManager, get_ui_font


class AboutDialog(QDialog):
    """
    Stratoshark Official About Dialog.
    """

    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("About Stratoshark")
        self.resize(600, 420)
        self._init_ui()
    ...
    def _init_ui(self):
        ...
        icon_lbl.setPixmap(StratosharkIcons.get_app_icon().pixmap(48, 48))
        hdr_layout.addWidget(icon_lbl)

        title_layout = QVBoxLayout()
        title_lbl = QLabel("Stratoshark", self)
        ...
        browser1.setHtml("""
            <p><b>Stratoshark</b> is a specialized system call and kernel observability analyzer derived from Wireshark.</p>
        ...
        browser2.setHtml("""
            <p><b>Wireshark & Stratoshark Creator:</b> Gerald Combs &lt;gerald@wireshark.org&gt;</p>
            <p><b>eBPF Observability & ML Integration:</b> KShark / Stratoshark Platform Team</p>
