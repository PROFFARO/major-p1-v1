"""
Stratoshark Backend Bridge — Connects Qt6 GUI with Go eBPF Agent, Live OS Collector, ML Detector, and DuckDB.
...
from stratoshark.core.os_collector import LiveOSTelemetryCollector

logger = logging.getLogger("stratoshark.bridge")


class BackendBridge(QObject):
    """
    Thread-safe bridge communicating between the Stratoshark GUI and the live OS/eBPF telemetry pipeline.
    """
    ...
    def _init_backend(self):
        ...
        try:
            ...
            # Hook raw event ingestion to emit to Stratoshark UI
    ...
    def start_capture(self, custom_ws_url: str = ""):
        ...
        threading.Thread(target=self._stats_loop, daemon=True, name="stratoshark-stats").start()
