"""
Stratoshark Persistent Settings Manager via QSettings.
"""
...
class StratosharkSettings:
    """Manages Stratoshark configuration profiles, geometry, and recent files."""

    def __init__(self):
        self.settings = QSettings("Stratoshark", "StratosharkObservability")
    ...
    def get_theme(self) -> str:
        return self.settings.value("theme", "stratoshark_dark")
